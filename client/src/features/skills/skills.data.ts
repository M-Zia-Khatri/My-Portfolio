...
import { SiExpress, SiMongodb, SiMysql, SiGit, SiGithub, SiDocker } from "react-icons/si";
...
export const skills: Skill[] = [
  ...
  // ── Terminal skills ─────────────────────────────────────────────────────────
  {
    ...
    commands: [
      ...
      { kind: "output", text: "Saved working directory and index state On feat: wip: half-done navbar" },
      { kind: "blank" },
  ...
  },
  {
    ...
    commands: [
      ...
      { kind: "output", text: "app         portfolio:latest   Up 2 seconds  0.0.0.0:3000->3000/tcp" },
